# Estudio del estado: Guerrero

## Instrucciones para Claude Code

Eres responsable de generar el estudio completo del estado de **Guerrero**. Esto significa producir 8 archivos en esta carpeta (`estados/11_guerrero/`), ejecutando uno tras otro los prompts genéricos correspondientes y aplicándolos al contexto de **Guerrero**.
...
### Contexto pre-cargado de Guerrero
...
- Turismo (Acapulco, Ixtapa-Zihuatanejo, Taxco)
- Minería (oro, plata — Filos, Los Filos)
- Agroindustria (coco, mango, copra)
- Pesca
- Joyería (Taxco)

#### Pistas de familias empresariales relevantes
- Familia Casares (turismo, varios negocios — Acapulco)
- Familia Iturbide (turismo)
- Familia Sotelo
...
- Las Brisas (hotelería Acapulco)
- Mexalit
- Equinox Gold (Los Filos)
- Hoteleros agrupados en AHETA Acapulco

#### Cámaras y asociaciones esperadas
- COPARMEX Guerrero
- CCE Guerrero
- Asociación de Hoteles y Empresas Turísticas de Acapulco (AHETA)
- Cámara Minera de México presencia
...
1. **Ranking Expansión 500** (`data/expansion/LCG_500_Empresas_Expansion_2025.csv`) — empresas cuya sede o operación principal sea Guerrero
2. **CRM HubSpot** (`data/crm/hubspot_empresas_AAA_AA.csv`) — filtra por `Estado de la República` == "Guerrero"
...
1. **La narrativa económica del estado en un párrafo** — el "elevator pitch" de qué es Guerrero hoy
...
5. **5 insights clave** que Fray debería tener en mente sobre Guerrero
...
> Ejecuta estados/11_guerrero/prompt.md completo, generando los 8 archivos y actualizando el README del estado.
```

O paso a paso, archivo por archivo:

```bash
> Ejecuta el paso 1 de estados/11_guerrero/prompt.md (panorama económico).
