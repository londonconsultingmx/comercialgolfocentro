# Estudio del estado: Estado de México

## Instrucciones para Claude Code

Eres responsable de generar el estudio completo del estado de **Estado de México**. Esto significa producir 8 archivos en esta carpeta (`estados/02_estado_de_mexico/`), ejecutando uno tras otro los prompts genéricos correspondientes y aplicándolos al contexto de **Estado de México**.
...
### Contexto pre-cargado de Estado de México
...
- Manufactura (uno de los hubs industriales más grandes del país)
- Automotriz y autopartes
- Química y farmacéutica
- Logística y centros de distribución (cercanía a CDMX)
- Alimentos y bebidas
- Construcción / vivienda

#### Pistas de familias empresariales relevantes
- González Sada (familia regiomontana con presencia)
- Saba (Casa Saba, Marzam)
- Familias regionales de Toluca y Naucalpan
...
- Chrysler / Stellantis (Toluca)
- Nissan, GM (presencia)
- Bimbo (planta principal)
- PI Group (cliente ya investigado por LCG)
- Grupo Modelo (planta importante)
- Iconn (de Soriana)
- Wallmart distribución
- 3M México (corporativo en Naucalpan)
- Pfizer México (Toluca planta)
- Procter & Gamble

#### Cámaras y asociaciones esperadas
- CAINTRA Estado de México
- COPARMEX Toluca
- COPARMEX Naucalpan
- Concamin EdoMex
...
1. **Ranking Expansión 500** (`data/expansion/LCG_500_Empresas_Expansion_2025.csv`) — empresas cuya sede o operación principal sea Estado de México
2. **CRM HubSpot** (`data/crm/hubspot_empresas_AAA_AA.csv`) — filtra por `Estado de la República` == "Estado de México"
...
1. **La narrativa económica del estado en un párrafo** — el "elevator pitch" de qué es Estado de México hoy
...
5. **5 insights clave** que Fray debería tener en mente sobre Estado de México
...
> Ejecuta estados/02_estado_de_mexico/prompt.md completo, generando los 8 archivos y actualizando el README del estado.
```

O paso a paso, archivo por archivo:

```bash
> Ejecuta el paso 1 de estados/02_estado_de_mexico/prompt.md (panorama económico).
