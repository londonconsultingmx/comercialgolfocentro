# Estudio del estado: Oaxaca

## Instrucciones para Claude Code

Eres responsable de generar el estudio completo del estado de **Oaxaca**. Esto significa producir 8 archivos en esta carpeta (`estados/12_oaxaca/`), ejecutando uno tras otro los prompts genéricos correspondientes y aplicándolos al contexto de **Oaxaca**.
...
### Contexto pre-cargado de Oaxaca
...
- Agroindustria (café, mezcal — el #1 productor nacional, frutas)
- Turismo (Oaxaca capital, costa: Huatulco, Puerto Escondido)
- Petróleo (refinería Salina Cruz)
- Energía eólica (Istmo de Tehuantepec)
- Artesanía (textil, alfarería, madera)
- Construcción

#### Pistas de familias empresariales relevantes
- Familia Toledo (Francisco Toledo artista pero hubo familia)
- Familia Murat (política-empresarial)
- Familia Cortés
...
- Productores de mezcal organizados (varios CRMs)
- Iberdrola México (parques eólicos)
- Enel Green Power México (eólico)
- Bachoco (operaciones)

#### Cámaras y asociaciones esperadas
- COPARMEX Oaxaca
- CCE Oaxaca
- Cámara de Comercio Oaxaca
- CRM Mezcal
- AMEXEÓLICA (asociación eólica)
...
1. **Ranking Expansión 500** (`data/expansion/LCG_500_Empresas_Expansion_2025.csv`) — empresas cuya sede o operación principal sea Oaxaca
2. **CRM HubSpot** (`data/crm/hubspot_empresas_AAA_AA.csv`) — filtra por `Estado de la República` == "Oaxaca"
...
1. **La narrativa económica del estado en un párrafo** — el "elevator pitch" de qué es Oaxaca hoy
...
5. **5 insights clave** que Fray debería tener en mente sobre Oaxaca
...
> Ejecuta estados/12_oaxaca/prompt.md completo, generando los 8 archivos y actualizando el README del estado.
```

O paso a paso, archivo por archivo:

```bash
> Ejecuta el paso 1 de estados/12_oaxaca/prompt.md (panorama económico).
