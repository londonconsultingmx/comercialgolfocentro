# Estudio del estado: Quintana Roo

## Instrucciones para Claude Code

Eres responsable de generar el estudio completo del estado de **Quintana Roo**. Esto significa producir 8 archivos en esta carpeta (`estados/06_quintana_roo/`), ejecutando uno tras otro los prompts genéricos correspondientes y aplicándolos al contexto de **Quintana Roo**.
...
### Contexto pre-cargado de Quintana Roo
...
- Turismo / hotelería (mayor concentración de México)
- Bienes raíces y desarrollo inmobiliario
- Construcción
- Retail y servicios al turismo
- Transporte y logística (aeropuerto Cancún #2 nacional)
- Servicios financieros (FIBRAs hoteleras, vacation ownership)

#### Pistas de familias empresariales relevantes
- Vidanta (Daniel Chávez — origen Sinaloa pero principal operación QR)
- Familias hoteleras locales (Roo, etc.)
- Inversionistas españoles, brasileños y americanos con propiedad significativa
...
- Grupo Vidanta
- Grupo TAFER & Villa Group
- Playa Hotels & Resorts (sede Cancún)
- Grupo Posadas (operaciones importantes)
- RLH Properties
- Palace Resorts (Roberto Chapur)
- Grupo Sunset (Roberto Chapur)
- Aeroméxico (operaciones)
- Volaris (operaciones)
- ASUR (Aeropuerto de Cancún)
- ITM Group MX
...
1. **Ranking Expansión 500** (`data/expansion/LCG_500_Empresas_Expansion_2025.csv`) — empresas cuya sede o operación principal sea Quintana Roo
2. **CRM HubSpot** (`data/crm/hubspot_empresas_AAA_AA.csv`) — filtra por `Estado de la República` == "Quintana Roo"
...
1. **La narrativa económica del estado en un párrafo** — el "elevator pitch" de qué es Quintana Roo hoy
...
5. **5 insights clave** que Fray debería tener en mente sobre Quintana Roo
...
> Ejecuta estados/06_quintana_roo/prompt.md completo, generando los 8 archivos y actualizando el README del estado.
```

O paso a paso, archivo por archivo:

```bash
> Ejecuta el paso 1 de estados/06_quintana_roo/prompt.md (panorama económico).
