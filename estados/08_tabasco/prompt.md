# Estudio del estado: Tabasco

## Instrucciones para Claude Code

Eres responsable de generar el estudio completo del estado de **Tabasco**. Esto significa producir 8 archivos en esta carpeta (`estados/08_tabasco/`), ejecutando uno tras otro los prompts genéricos correspondientes y aplicándolos al contexto de **Tabasco**.
...
### Contexto pre-cargado de Tabasco
...
- Petróleo y energía (refinería Dos Bocas, Pemex Exploración)
- Construcción (boom por refinería)
- Agroindustria (cacao, plátano, ganado)
- Servicios al sector energético
- Logística fluvial (ríos Usumacinta, Grijalva)

#### Pistas de familias empresariales relevantes
- Familia Pemueles (tradicional)
- Familia Rovirosa
- Familia Ramos
- Familia Madrazo (política-empresarial)
...
- Pemex Exploración y Producción (sede regional)
- Refinería Olmeca (Dos Bocas)
- Constructoras locales beneficiadas por obra pública
- Bachoco (operaciones)

#### Cámaras y asociaciones esperadas
- COPARMEX Tabasco
- CCE Tabasco
- Cámara de Comercio Villahermosa
- Canacintra Tabasco
- Alumni UJAT
...
1. **Ranking Expansión 500** (`data/expansion/LCG_500_Empresas_Expansion_2025.csv`) — empresas cuya sede o operación principal sea Tabasco
2. **CRM HubSpot** (`data/crm/hubspot_empresas_AAA_AA.csv`) — filtra por `Estado de la República` == "Tabasco"
...
1. **La narrativa económica del estado en un párrafo** — el "elevator pitch" de qué es Tabasco hoy
...
5. **5 insights clave** que Fray debería tener en mente sobre Tabasco
...
> Ejecuta estados/08_tabasco/prompt.md completo, generando los 8 archivos y actualizando el README del estado.
```

O paso a paso, archivo por archivo:

```bash
> Ejecuta el paso 1 de estados/08_tabasco/prompt.md (panorama económico).
