...
def chrome_header(active: str = "") -> str:
    ...
    <a href="index.html" class="brand">
        <img src="assets/lcg-wordmark.svg" alt="London Consulting Group" class="wordmark">
...
.brand-tag { font-family: 'Manrope', sans-serif; font-size: 10px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; color: var(--lcg-dark); padding-left: 12px; border-left: 1px solid var(--lcg-line); }
